  ...
  const handleAddToCart = (product) => {    
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> 
                    ...
                    <h1 className='cart'>
                        {totalIncart ?(
                            <span className='cart_quantity_count'>{totalIncart}</span>
                        ):<span></span>}
        ...
        {plantsArray.map((category, index) => (
            <div key={index}> {/* key ajouté ici pour chaque catégorie */}
                <h1 className='product-list'> {category.category} </h1>
                <div className='product-list'>
                    {category.plants.map((plant) => (
                        <div className='product-card' key={plant.name}> {/* key ajouté ici pour chaque plante */}
                            ...
                            <button
                              ...
                              onClick={() => handleAddToCart(plant)} // Ajout d'une fonction fléchée ici
                            >
                                Add to cart
                            </button>
                        </div>
